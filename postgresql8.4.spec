...
%define current_major_version 8.4
...
Conflicts: %{bname}8.3-test < %{current_major_version}
...
Conflicts:  %{_lib}ecpg-devel < %{current_major_version}
...
Conflicts:  %{bname}-devel < %{current_major_version}
...
Conflicts:  postgresql-pl < %{current_major_version}
